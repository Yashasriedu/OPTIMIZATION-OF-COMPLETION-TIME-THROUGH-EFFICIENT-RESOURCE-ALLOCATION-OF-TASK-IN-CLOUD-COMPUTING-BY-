...
//   System.out.println("out===="+m.group(0));
            ...
            BufferedWriter writer1 = new BufferedWriter(new FileWriter(inputFolder
                    + "\\Performance\\SimpleGA\\Result_" + numberoftask + ".txt", true));
            ...
            Parameters.PlanningAlgorithm pln_method = Parameters.PlanningAlgorithm.SGA;
            ...
            WorkflowDatacenter datacenter0 = createDatacenter("SimpleGA-Schedule", hostNum);
    ...
    protected static void printJobList(List<Job> list, int totaltask) throws IOException {
        try {
            ...
            BufferedWriter writer1 = new BufferedWriter(new FileWriter(inputFolder + "/Performance/SimpleGA/Result_" + totaltask + ".txt", true));
            ...
            String stm = "INSERT INTO SGAMakespan(NumberOfTasks,Makespan) VALUES('" + totaltask + "','" + makespan + "')";
