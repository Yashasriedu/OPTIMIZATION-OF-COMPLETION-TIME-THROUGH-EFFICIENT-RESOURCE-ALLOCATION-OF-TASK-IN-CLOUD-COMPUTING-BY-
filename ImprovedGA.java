...
//   System.out.println("out===="+m.group(0));
            ...
            BufferedWriter writer1 = new BufferedWriter(new FileWriter(inputFolder
                    + "\\Performance\\IGA\\Result_" + numberoftask + ".txt", true));
            ...
            Parameters.PlanningAlgorithm pln_method = Parameters.PlanningAlgorithm.IGA;
            ...
            WorkflowDatacenter datacenter0 = createDatacenter("ImprovedGA-Schedule", hostNum);
    ...
    protected static void printJobList(List<Job> list, int totaltask) throws IOException {
        ...
        try {
            ...
            BufferedWriter writer1 = new BufferedWriter(new FileWriter(inputFolder + "\\Performance\\IGA\\Result_" + totaltask + ".txt", true));
            ...
            for (int i = 0; i < size; i++) {
                ...
                Cost = job.getCostPerSec(job.getResourceId());
            ...
            String stm = "INSERT INTO IGAMakespan(NumberOfTasks,Makespan) VALUES('" + noofTasks + "','" + makespan + "')";
            String stm1 = "INSERT INTO IGAExpense(NumberOfTasks,cost) VALUES('" + noofTasks + "','" + Cost + "')";
