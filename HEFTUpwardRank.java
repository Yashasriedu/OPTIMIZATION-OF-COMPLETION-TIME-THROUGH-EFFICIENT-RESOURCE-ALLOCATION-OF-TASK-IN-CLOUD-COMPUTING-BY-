 ...
 * @author soft29
 */
public class HEFTUpwardRank {

    // to connect Database
    static final String url = "jdbc:mysql://localhost:3306/";
    static final String driver = "com.mysql.jdbc.Driver";
    static final String dbname = "HybridTaskSchedule";
...
//   System.out.println("out===="+m.group(0));
            ...
            BufferedWriter writer1 = new BufferedWriter(new FileWriter(inputFolder
                    + "/Performance/HEFTUpwardRanked/Result_" + numberoftask + ".txt", true));
            ...
            WorkflowDatacenter datacenter0 = createDatacenter("HEFTUpward-Schedule", hostNum);
    ...
    protected static void printJobList(List<Job> list, int totaltask) throws IOException {
        ...
        try {
            ...
            BufferedWriter writer1 = new BufferedWriter(new FileWriter(inputFolder + "\\Performance\\HEFTUpwardRanked\\Result_" + totaltask + ".txt", true));
            ...
            String stm = "INSERT INTO HeftUpwardMakespan(NumberOfTasks,Makespan) VALUES('" + noofTasks + "','" + makespan + "')";
